...
/* **********************************************
     Begin prism-core.js
********************************************** */
// $.getScript("prism.js", function() {
//    alert("Script loaded but not necessarily executed.");
// });
/* PrismJS 1.9.0
http://prismjs.com/download.html?themes=prism-okaidia&languages=markup+css+clike+javascript+bash+batch+django+git+go+http+json+markdown+nginx+python+r+sql+textile+vim&plugins=line-highlight+line-numbers+autolinker+file-highlight+toolbar+jsonp-highlight+highlight-keywords+command-line+show-language+copy-to-clipboard */
